...
import { corporateLunchSlides } from '@/lib/slides/corporate-lunch'
...
function CorporateLunchContent() {
  ...
  const renderSlideContent = (slide: typeof corporateLunchSlides[0]) => {
    switch (slide.layout) {
      case 'fullBleed':
      ...
      case 'centered':
        // Special handling for Slide 3 (Target Outcomes) - display as stats
        if (slide.id === 3) {
          return (
            <div className="h-full min-h-full flex items-center justify-center px-8 py-16">
              <div className="max-w-4xl w-full text-center text-washi">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mt-12">
                  <div>
                    <div className="text-5xl md:text-6xl lg:text-7xl font-bold text-kincha mb-4">3-5</div>
                    <div className="text-xl md:text-2xl text-hai">buildings</div>
                  </div>
                  <div>
                    <div className="text-5xl md:text-6xl lg:text-7xl font-bold text-kincha mb-4">40-60</div>
                    <div className="text-xl md:text-2xl text-hai">weekly covers</div>
                  </div>
                  <div>
                    <div className="text-5xl md:text-6xl lg:text-7xl font-bold text-kincha mb-4">Recurring</div>
                    <div className="text-xl md:text-2xl text-hai">revenue</div>
                  </div>
                </div>
              </div>
            </div>
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="fixed top-8 right-8 z-50 px-4 py-2 bg-beni/20 border border-beni/40 rounded-lg">
        <span className="text-sm text-washi font-medium">Mini Story 2: Corporate Lunch</span>
      </div>
