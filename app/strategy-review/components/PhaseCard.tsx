    ...
    <div className={`${theme.bg} ${theme.border} border-2 rounded-lg p-6 h-full flex flex-col`}>
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          <div className={`${theme.badge} text-white font-bold px-3 py-1 rounded-full inline-block mb-2`}>
            Phase {phaseNumber}
          </div>
      ...
      {/* Strategy Examples */}
      <div className="mb-6">
        <h4 className="font-semibold mb-2 text-gray-200">Strategy Examples:</h4>
      ...
      <div className="mt-auto">
        <h4 className="font-semibold mb-2 text-gray-200">Key Outcomes:</h4>
        <ul className="space-y-1 text-gray-300">
