          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-700/50">
              ...
              <tr className="bg-[#b22222]/10">
                ...
                <td className="p-4 text-white font-semibold">Social Night "Meet & Mingle"</td>
                <td className="p-4 text-gray-300">7-10pm</td>
      ...
      >
        <div className="space-y-8">
          ...
          <div className="bg-blue-900/10 border-l-4 border-blue-500 rounded p-6">
            <h5 className="font-bold text-white mb-4">Implementation Checklist</h5>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <div className="font-semibold text-blue-300 mb-3">3 Weeks Before Launch:</div>
                <ul className="space-y-2 text-sm text-gray-300">
                  <li className="flex items-start gap-2">
                    <span className="text-gray-500">☐</span>
                    <span>Confirm instructor and book first 4 sessions</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-500">☐</span>
                    <span>Create social media graphics and event page</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-500">☐</span>
                    <span>Order bar supplies for Latin cocktail menu</span>
                  </li>
                </ul>
              </div>
              <div>
                <div className="font-semibold text-blue-300 mb-3">2 Weeks Before Launch:</div>
                <ul className="space-y-2 text-sm text-gray-300">
                  <li className="flex items-start gap-2">
                    <span className="text-gray-500">☐</span>
                    <span>Print flyers and begin distribution</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-500">☐</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-gray-500">☐</span>
                    <span>Train staff on event format and entry fee collection</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      >
        <div className="space-y-8">
          ...
          <div className="card-dark p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              <div className="bg-gray-900 rounded p-4">
                <div className="text-[#D4AF37] font-bold mb-2">"Social Starter" Cocktails - $8</div>
                <div className="text-gray-400">Japanese Mule, Sake Sangria, Lychee Martini</div>
              </div>
              <div className="bg-gray-900 rounded p-4">
                <div className="text-[#D4AF37] font-bold mb-2">"Share the Love" Platters - $22-28</div>
                <div className="text-gray-400">Designed for 2-3 people to share</div>
              </div>
              <div className="bg-gray-900 rounded p-4">
                <div className="text-[#D4AF37] font-bold mb-2">"First-Timer" Special</div>
                <div className="text-gray-400">Buy 2 drinks, get appetizer half-off</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="card-dark p-10 shadow-strong border-2 border-[#b22222]/30 mt-10">
        ...
        <div className="bg-blue-900/10 border-l-4 border-blue-500 rounded p-6">
          ...
          <ul className="space-y-2 text-gray-300">
            ...
            <li className="flex items-center gap-3">
              <span className="text-[#b22222]">✓</span>
              <span>Thursday Social Night "Meet & Mingle"</span>
            </li>
            <li className="flex items-center gap-3">
              <span className="text-[#b22222]">✓</span>
